  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row
      .col-lg-8.order-2.order-lg-1(data-aos="fade-right")
        ...
        p.mb-0 Dentro de estos patrones de arquitectura, se encuentran diferentes tipos, que permiten generar software con mayor rendimiento. Algunos de estos son:
    ...
    .row.bg-c3
      .col-12
        .px-5
          ...
          .row.mb-5
            .col-lg-8.order-2.order-lg-1(data-aos="fade-right")
              p Los estilos son un complemento de los patrones de diseño, como los arquitectónicos de software, y lo importante aquí es que se preocupan por los stakeholders. Por lo tanto, los estilos se preocupan por el tratamiento estructural del software.
              p Cuando se aplican estilos arquitectónicos en el desarrollo de software, se le da un valor distintivo a la calidad del software. Los estilos son un conjunto de componentes, como bases de datos o módulos de cómputo, que son utilizados para realizar una función y, por medio de conectores, permiten la comunicación, coordinación y cooperación entre ellos, #[b “el todo es la suma de sus partes”].
              .row.mb-3
                .col-12.bg-c7
                  .p-4
                    .row.align-items-center
            ...
            SlyderA(tipo="b")
              .row.align-items-center.justify-content-center
                ...
                .col-lg-6.mb-4.mb-lg-0.order-1.order-lg-2
                  figure
                    img(src='@/assets/curso/tema2/img13.svg', style="width:480px", alt='').m-auto
              .row.align-items-center.justify-content-center
                .col-lg-4.order-2.order-lg-1
              ...
              .row.align-items-center.justify-content-center
                .col-lg-4.order-2.order-lg-1
                  ...
                  p.text-white.mb-0 Refleja la estructura del lenguaje de programación. Permite al diseñador del software construir una estructura de programa relativamente fácil de modificar y ajustar a escala. Se basa en la bien conocida abstracción de procedimientos/funciones/métodos.
                .col-lg-6.mb-4.mb-lg-0.order-1.order-lg-2
                  figure
                    img(src='@/assets/curso/tema2/img15.svg', style="width:480px", alt='').m-auto
              .row.align-items-center.justify-content-center
                .col-lg-4.order-2.order-lg-1
                ...
                .col-lg-6.mb-4.mb-lg-0.order-1.order-lg-2
                  figure
                    img(src='@/assets/curso/tema2/img16.svg', style="width:480px", alt='').m-auto
              .row.align-items-center.justify-content-center
                .col-lg-4.order-2.order-lg-1
                ...
                .col-lg-6.mb-4.mb-lg-0.order-1.order-lg-2
                  figure
                    img(src='@/assets/curso/tema2/img17.svg', style="width:480px", alt='').m-auto
              .row.align-items-center.justify-content-center
                .col-lg-4.order-2.order-lg-1
                ...
                .col-lg-6.mb-4.mb-lg-0.order-1.order-lg-2
                  figure
                    img(src='@/assets/curso/tema2/img18.svg', style="width:480px", alt='').m-auto
              .row.align-items-center.justify-content-center
                .col-lg-4.order-2.order-lg-1
                ...
                .col-lg-6.mb-4.mb-lg-0.order-1.order-lg-2
                  figure
                    img(src='@/assets/curso/tema2/img19.svg', style="width:480px", alt='').m-auto
